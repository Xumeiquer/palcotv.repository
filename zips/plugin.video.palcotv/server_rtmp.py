...
def resolve_iguide(params):
    plugintools.log("PalcoTV.resolve_iguide " + repr(params) )
...
def resolve_ucaster(params):
    plugintools.log("PalcoTV.resolve_ucaster " + repr(params) )
...
def play_iguide(iguide_palco, iguide_user):
    plugintools.log("PalcoTV.iGuide PalcoTV= " + repr(iguide_palco) )
    plugintools.log("PalcoTV.iGuide User= " + repr(iguide_user) )
